...
module.exports = function getRoutes(data) {
  var templateWrapper = function templateWrapper(template) {
    var Template = require("C:\\Users\\Administrator\\Desktop\\ccui\\packages\\ccui-design\\site\\theme/template".concat(template.replace(/^\.\/template/, '')));

    return Template;
  };

  var themeRoutes = JSON.parse('[{"component":"./template/Layout","routes":[{"path":"/","exact":true,"component":"./template/Home"},{"path":"/components/:name","component":"./template/Content"}]}]');
